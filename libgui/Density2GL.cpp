...
void Density2GL::setupIndexTable()
{
	...
	// type 9
//	_cubeIndices[0b00011011] = makeList(12, y, xy2, 1, 1, xy2, z,
//	                                    xy2, z, x2, 0);
	// type 9 FIXME
	_cubeIndices[0b11100100] = makeList(0);
	...
	// type 15 FIX ME 
	_cubeIndices[0b11011000] = makeList(0); 
	...
	// type 9
//	_cubeIndices[0b00101101] = makeList(12, 0, 0, y, xz1, xz1, y, 2,
//	                                    xz1, 2, z, y, 1, 2);
	/* FIX ME */
	_cubeIndices[0b11010010] = makeList(0);
	// 80
	...
	_cubeIndices[0b00110110] = makeList(12, x1, xz1, 0, 0, xz1, y2,
	                                    xz1, y2, yz, 0, y, y2);
	_cubeIndices[0b11001001] = _cubeIndices[0b00110110];

	_cubeIndices[0b00110111] = makeList(9, xz1, z1, x1, z1, x1, y,
	                                    x1, y, y2);
	...
	_cubeIndices[0b00111010] = makeList(12, 0, 2, y, 2, y, xz1,
	                                    xz1, 2, z1, y, xz1, xy2);
	// type 15
	_cubeIndices[0b11000101] = makeList(0);
	...
	// type 11
	_cubeIndices[0b01001010] = makeList(9, 2, y, yz, 2, yz, z,
	                                    0, x1, x2); 
	...
	// type 15
	_cubeIndices[0b01001011] = makeList(0);
	_cubeIndices[0b10110100] = makeList(0);
	...
	// type 15
	_cubeIndices[0b01010110] = makeList(0);
	_cubeIndices[0b10101001] = makeList(0);
	...
	// type 15
//	_cubeIndices[0b01011010] = makeList(12, y, 0, x2, y, x2, xy2,
//	                                    z, 2, y2, z, y2, yz);
//	_cubeIndices[0b10100101] = makeList(12, 0, y, y2, 0, y2, 2,
//	                                    x2, xy2, yz, x2, yz, z);
	
	// cancel
	_cubeIndices[0b01011010] = makeList(0);
	_cubeIndices[0b10100101] = makeList(0);
	...
	/*
	_cubeIndices[0b01011100] = makeList(
	_cubeIndices[0b10100011] = _cubeIndices[0b01011100];
	*/
	...
	// type 9
	_cubeIndices[0b01101010] = makeList(0);
	_cubeIndices[0b10010101] = makeList(0);
	...
	_cubeIndices[0b01110100] = makeList(12, x2, z, xz1, x1, y, z1, 
	                                    x1, z1, xy2, z1, xy2, yz);
	_cubeIndices[0b10001011] = _cubeIndices[0b01110100];
