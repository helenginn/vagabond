...
GeomTable::GeomTable()
{
	...
	addBondAngle(AtomTyrCB, AtomTyrCA, AtomC, 110.4);
	addBondAngle(AtomTyrCA, AtomTyrCB, AtomTyrCG, 113.4);
	...
	addBondAngle(AtomAspCB, AtomAspCG, AtomAspOD2, 123.3);
